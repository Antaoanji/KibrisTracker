...
class SettingsManager @Inject constructor(private val dataStore: DataStore<Preferences>) {
    ...
    val dailyGoalFlow: Flow<Int> = dataStore.data
    ...
    val dailyWaterGoalFlow: Flow<Int> = dataStore.data
    ...
    val waterReminderEnabledFlow: Flow<Boolean> = dataStore.data
    ...
    val waterReminderFrequencyFlow: Flow<Int> = dataStore.data
    ...
    val currentStreakFlow: Flow<Int> = dataStore.data
    ...
    val unlockedBadgesFlow: Flow<Set<String>> = dataStore.data
